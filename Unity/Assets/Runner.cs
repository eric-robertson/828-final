...
public class Runner : MonoBehaviour
{
    ...
    void RunItteration(int trial)
    {
        ...
        scene.create("cube0", "cube");
        scene.create("ball0", "ball");
        scene.create("platform", "platform");
        scene.placeAbove("cube0", "platform");
        scene.placeAbove("ball0", "platform");
        scene.setAttribute("cube0", "bouncy", "" );
        scene.setAttribute("cube1", "bouncy", "" );

        IEnumerator RunSim() 
        {
            yield return new WaitForSeconds(8);
            scene.clearScene(999);
        }
        ...
        int objectNumber = randRange(1, 4);
        ...
        // Attributes
        int attributeCount = randRange(0, 3);
